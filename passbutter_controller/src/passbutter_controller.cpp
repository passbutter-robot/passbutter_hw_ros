...
#include "passbutter_controller/passbutter_controller.hpp"
...
namespace passbutter_controller
{
using hardware_interface::LoanedCommandInterface;

PassbutterController::PassbutterController()
...
PassbutterController::init(const std::string & controller_name)
{
...
CallbackReturn PassbutterController::on_configure(
...
PassbutterController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
PassbutterController::state_interface_configuration() const
{
...
CallbackReturn PassbutterController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn PassbutterController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::return_type PassbutterController::update()
{
...
PLUGINLIB_EXPORT_CLASS(
  passbutter_controller::PassbutterController, controller_interface::ControllerInterface)
